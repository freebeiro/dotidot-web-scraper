  ...
  describe ".call" do
    context "basic extraction" do
      ...
      it "extracts multiple fields" do
        fields = [
          ...
          { name: "first_product", selector: ".product:first .name", type: "text" },
          { name: "first_price", selector: ".product:first .price", type: "text" }
        ]
    ...
    context "error handling" do
      ...
      it "handles invalid selectors" do
        field = { name: "invalid", selector: "!!!invalid", type: "text" }
    ...
    context "complex selectors" do
      it "handles pseudo-selectors" do
        fields = [
          { name: "first_li", selector: "li:first-child", type: "text" },
          { name: "last_li", selector: "li:last-child", type: "text" },
          { name: "second_li", selector: "li:nth-child(2)", type: "text" }
        ]
    ...
    context "transformation options" do
      ...
      it "handles transformation errors" do
        field = ExtractedField.new(
          ...
          selector: ".title",
          type: "text",
          transform: ->(_text) { raise "Transform error" }
        )
    ...
    context "edge cases" do
      ...
      it "handles very long text content" do
        ...
        expect(result[:success]).to be true
        expect(result[:data]["long"].length).to eq(10_000)
      end
